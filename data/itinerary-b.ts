...
const en: DayData[] = [
  {
    ...
    hotel: { name: "W Barcelona", stars: 5, description: "Iconic sail-shaped building on the seafront with unbeatable ocean views", price: "$250/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "W Barcelona", stars: 5, description: "Second night", price: "$250/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "W Barcelona", stars: 5, description: "Third night", price: "$250/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "The Westin Valencia", stars: 5, description: "Adjacent to the City of Arts and Sciences — design-forward luxury", price: "$150/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=Westin+Valencia" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Grand Hotel Ibiza", stars: 5, description: "Beachfront hotel on Poniente Bay with private beach", price: "$340/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=Grand+Hotel+Ibiza" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Grand Hotel Ibiza", stars: 5, description: "Second night", price: "$340/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=Grand+Hotel+Ibiza" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Sol Meliá Mallorca", stars: 4, description: "Beachfront on the Bay of Palma with private beach", price: "$165/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=Sol+Melia+Mallorca+Palma" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Sol Meliá Mallorca", stars: 4, description: "Second night", price: "$165/night", mapUrl: "https://www.google.com/maps/search/?api=1&query=Sol+Melia+Mallorca+Palma" },
    food: [
...
const ja: DayData[] = [
  {
    ...
    hotel: { name: "Wバルセロナ", stars: 5, description: "帆船型の象徴的な建物、海沿いのロケーションで絶景の海景色", price: "¥36,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Wバルセロナ", stars: 5, description: "2泊目", price: "¥36,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "Wバルセロナ", stars: 5, description: "3泊目", price: "¥36,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=W+Hotel+Barcelona" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "ウェスティン・バレンシア", stars: 5, description: "芸術科学都市に隣接するデザインホテル", price: "¥22,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=Westin+Valencia" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "グランドホテル・イビサ", stars: 5, description: "ポニエンテ湾のビーチフロントホテル、プライベートビーチ付き", price: "¥50,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=Grand+Hotel+Ibiza" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "グランドホテル・イビサ", stars: 5, description: "2泊目", price: "¥50,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=Grand+Hotel+Ibiza" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "ソル・メリア・マジョルカ", stars: 4, description: "パルマ湾の海辺、プライベートビーチ付き", price: "¥24,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=Sol+Melia+Mallorca+Palma" },
    food: [
  ...
  },
  {
    ...
    hotel: { name: "ソル・メリア・マジョルカ", stars: 4, description: "2泊目", price: "¥24,000/泊", mapUrl: "https://www.google.com/maps/search/?api=1&query=Sol+Melia+Mallorca+Palma" },
    food: [
